...
class FocusSquare: SCNNode {
    ...
    @objc func update(for position: SCNVector3, planeAnchor: ARPlaneAnchor?, camera: ARCamera?) {
...
class FocusSquareSegment: SCNNode {
    ...
    @objc init(name: String, width: Float, thickness: Float, color: UIColor, vertical: Bool = false) {
        super.init()
